...
**80 problems solved across core algorithmic patterns (automatically tracked and updated).**
...
<!-- TRACKER_START -->
**80 problems solved** (Python)  
**Difficulty:** 32 Easy · 45 Medium · 3 Hard  
...
<details>
<summary><strong>Linked List</strong> — 8 problems</summary>
